...
// copy of Java SimpleFormatter plus added ANSI color commands to highlight the messages
 ...
 */
 ...
 public class LoggerColoredSimpleFormatter extends SimpleFormatter {
      ...
      */
     public LoggerColoredSimpleFormatter() {}
     ...
     public String format(LogRecord record) {
         ...
         return String.format(
                switch (record.getLevel().intValue()) {
                    case(300): yield ANSI_CYAN;
                    case(400): yield ANSI_CYAN;
                    case(500): yield ANSI_CYAN;
                    case(700): yield ANSI_GREEN;
                    case(800): yield ANSI_WHITE;
                    case(900): yield ANSI_YELLOW;
                    case(1000): yield ANSI_RED;
                    default: yield 0;
                }
                + format + ANSI_RESET,
                              zdt,
